...
LUA_REGISTER_SINKS: List[Sink] = [
    Sink(name="luaL_register", vulnerable_parameters=[3]),
]

C2Lua_API_SINK: List[Sink] = [
    Sink(name="luaL_loadfile", vulnerable_parameters=[2]),
]
...
BUFFER_OVERFLOW_SINKS: List[Sink] = [
    ...
    Sink(name="sprintf", vulnerable_parameters=[3]),
